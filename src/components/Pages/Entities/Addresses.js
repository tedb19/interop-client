    ...
    <RibbonSection heading="System Addresses" color="orange">
      <Card.Group className="addresses">
        <Card color="teal" className="address-card">
          <Card.Content>
            <Icon
              name={props.httpstatusIconName}
              className="address-status"
              size="large"
              color={props.httpstatusIconColor}
            />
            ...
            <Card.Description>
              This should be a POST endpoint on the participating system. The IL
              will be doing an HTTP POST to this address.
            </Card.Description>
          </Card.Content>
          <Card.Content extra className="system-address-area">
            ...
            {props.httpAddressInputVisible ? (
              <Tooltip
                ...
                overlay={
                  <span>
                    Add the http address, then press Enter.<br /> Or <br />{" "}
                    Click the "cancel update" link to opt out
                  </span>
                }
              >
                <Input
        ...
        <Card color="teal" className="address-card">
          <Card.Content>
            <Icon
              name={props.tcpstatusIconName}
              className="address-status"
              size="large"
              color={props.tcpstatusIconColor}
            />
            <Card.Header className="address-card-header">
              TCP Address
            </Card.Header>
            ...
            <Card.Description>
              This should be a TCP port where the participating system will be
              listening on. The IL will be sending the messages to this port.
            </Card.Description>
          </Card.Content>
          <Card.Content extra className="system-address-area">
            ...
            {props.tcpAddressInputVisible ? (
              <Tooltip
                ...
                overlay={
                  <span>
                    Add the tcp address, then press Enter.<br /> Or <br /> Click
                    the "cancel update" link to opt out
                  </span>
                }
              >
                <Input
