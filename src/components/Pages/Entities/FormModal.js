...
export const FormModal = props => {
  ...
  return (
    ...
    >
      <Modal.Header className="modal-header">New system:</Modal.Header>
      <Modal.Content className="modal-content">
        ...
        <Message size="small" color="teal" icon>
          ...
          <Message.Content>
            ...
            Adding a system means it will be available to participate on the
            integration. However, the system will not be <strong>
              ACTIVE
            </strong>{" "}
            until it's assigned a valid address. This will be done at the
            facility.
          </Message.Content>
        </Message>
        ...
        <Form className="modal-form">
          ...
          <Form.Field
            ...
            label="Description"
            required
            placeholder="A brief description about the system.."
            name="description"
