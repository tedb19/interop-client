...
export const FormModal = props => {
  ...
  return (
    ...
    >
      <Modal.Header className="modal-header">New message type:</Modal.Header>
      <Modal.Content className="modal-content">
        ...
        <Message size="small" color="teal" icon>
          ...
          <Message.Content>
            ...
            Adding a new message type means the participating systems can now
            begin exchanging information using this message type. The new
            message type must be based on{" "}
            <a href="https://www.hl7.org/implement/standards/product_brief.cfm?product_id=148">
              <u>hl7 v2</u>
            </a>, and must contain atleast all the data elements contained on
            the{" "}
            <strong>
              <u>green card</u>
            </strong>, and additionally can contain any other partner-specific
            data elements.
          </Message.Content>
        </Message>
        ...
        <Form className="modal-form">
          ...
          <Form.Field
            ...
            label="Description"
            required
            placeholder="A brief description about the message type.."
            name="description"
